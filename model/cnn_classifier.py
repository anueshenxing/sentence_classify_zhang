...
def build_model(tparams, options):
    ...
    layer0_input = tparams['Wemb'][tensor.cast(x.flatten(), dtype='int32')].reshape(
        (x.shape[0], 1, x.shape[1], tparams['Wemb'].shape[1]))
    ...
    for i in xrange(len(options['filter_hs'])):
        ...
        conv_layer = encoder(tparams, layer0_input, filter_shape=filter_shape, pool_size=pool_size,
